...
export default function PricingPayment() {
  ...
  // Ganti dengan nomor WhatsApp kamu (Gunakan kode negara 62)
  const waNumber = "6285179835214"; 
  ...
  // KODE RAHASIA UNTUK MEMBUKA AKSES PRO (Bisa kamu ganti sesuka hati)
  const SECRET_TOKEN = "MATCHPRO26";

  const handleManualConfirmation = () => {
    // Membuka WhatsApp di tab baru untuk kirim bukti
  ...
  const handleActivateToken = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      // Mengecek apakah token yang dimasukkan sama dengan token rahasia
      if (tokenInput.toUpperCase() === SECRET_TOKEN) {
        // JIKA BENAR: Suntikkan status premium ke sistem
        ...
        router.push("/dashboard"); // Lempar kembali ke dashboard
      } else {
        // JIKA SALAH
      ...
      <div className="w-full max-w-4xl bg-[#0a1120]/80 backdrop-blur-xl p-8 md:p-10 rounded-3xl border border-cyan-500/20 shadow-[0_0_50px_rgba(34,211,238,0.1)] relative z-10 grid grid-cols-1 md:grid-cols-12 gap-10">
        ...
        <div className="md:col-span-5 border-b md:border-b-0 md:border-r border-slate-800 pb-8 md:pb-0 md:pr-8 flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-2xl font-black text-white mt-4 mb-2 tracking-tight">MatchMyPath PRO</h2>
        ...
        <div className="md:col-span-7 flex flex-col justify-between">
          ...
          <div className="mb-8">
            ...
            <p className="text-xs text-slate-400 mb-4 leading-relaxed">
              Setelah melakukan transfer uang sungguhan, klik tombol di bawah untuk mengirimkan bukti resi via WhatsApp. Admin akan mengecek mutasi dan memberikan Anda <strong className="text-white">Token Aktivasi</strong>.
            </p>
            <button 
          ...
          <div className="bg-[#050b14] p-6 rounded-2xl border border-slate-800">
            ...
            <p className="text-xs text-slate-400 mb-4 leading-relaxed">
              Masukkan 10 digit Token Aktivasi yang Anda dapatkan dari Admin untuk membuka akses PRO.
            </p>
